...
struct Cli {
	...
	#[allow(dead_code, reason = "field never read; clap ArgAction handles the flag")]
	...
	#[allow(dead_code, reason = "accepted for GNU grep alias compat, intentionally ignored")]
	#[arg(
		long = "color",
		alias = "colour",
		value_name = "WHEN",
